  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['dbstreif/iambic-controller', 'dbstreif/Distrubuted-NPB-Testbench', 'dbstreif/heartbeatstyle-gossip', 'dbstreif/Giggity', 'dbstreif/nvim-config', 'dbstreif/ChristmasPI', 'dbstreif/SpaceX-API-PY', 'dbstreif/RogueCompany', 'dbstreif/libmalloc'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'Featured',
